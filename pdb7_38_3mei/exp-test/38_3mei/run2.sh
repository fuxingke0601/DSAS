...
echo "good"
####################################calc resolution#########################
reso=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python ../reso_cal.py shelxC.log shelx_ecal_cad.mtz)
...
######################################calc cctr######################################
#####################################################################################
cctr=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python cctr_cal.py $mtz)
...
weak1_nan=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python nan_cal.py para_test_${weak1}/log_${weak1}.txt)
weak2_nan=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python nan_cal.py para_test_${weak2}/log_${weak2}.txt)
weak3_nan=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python nan_cal.py para_test_${weak3}/log_${weak3}.txt)
weak4_nan=$(/home/fuxingke/anaconda3/envs/dsas_python3_10/bin/python nan_cal.py para_test_${weak4}/log_${weak4}.txt)
#weak1_nan=4
#weak2_nan=4
#weak3_nan=4
#weak4_nan=0
